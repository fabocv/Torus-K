      ...
      .dashboard-bg {
        background:
          radial-gradient(
            ...
            color-mix(in srgb, #00ff88 8%, transparent) 0%,
            transparent 70%
          ),
          radial-gradient(
            ellipse 60% 40% at 90% 110%,
            color-mix(in srgb, #00e5ff 5%, transparent) 0%,
            transparent 60%
          ),
          var(--color-torus-bg);
      }
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-10">
          ...
          <div class="flex items-baseline gap-3 mb-3">
            <h1
              class="brand-gradient font-mono font-black tracking-tight
        ...
        <div class="onboarding-panel">
          ...
          <p>Implementar Torus K ofrece las siguientes ventajas:</p>
          <ul>
            <li>
              <b>Mejora la visibilidad</b>: Asegura que los agentes de IA reconozcan y recomienden
              tu sitio.
            </li>
            <li>
              <b>Elimina alucinaciones</b>: Provee claridad sobre las intenciones de los elementos,
              evitando confusiones en las respuestas de la IA.
            </li>
            <li>
              <b>Optimización para el futuro</b>: Prepara tu web para la próxima generación de
